...
- **Permutation invariant**: The multiset of elements in the array after sorting equals the multiset of elements before sorting. This proves no elements were fabricated, lost, or duplicated — only rearranged.
...
- **In-place**: The sort modifies the input array directly (Dafny `modifies a` clause) without allocating a new array.
